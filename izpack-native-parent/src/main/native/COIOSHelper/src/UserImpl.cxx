...
#include "com_coi_tools_os_win_UserImpl.h"
#include <windows.h>
#include <lmcons.h>

/*
 * Class:     com_coi_tools_os_win_UserImpl
 * Method:    isUserAnAdmin
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_coi_tools_os_win_UserImpl_isUserAnAdmin(JNIEnv *env, jclass cls)
{
   BOOL   fReturn         = FALSE;
   DWORD  dwStatus;
   DWORD  dwAccessMask;
